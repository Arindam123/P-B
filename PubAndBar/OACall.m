...
#import "OAServiceTicket_LinkedIn.h"
#import "OAMutableURLRequest_LinkedIn.h"
#import "OACall.h"

@interface OACall (Private)

- (void)callFinished:(OAServiceTicket_LinkedIn *)ticket withData:(NSData *)data;
- (void)callFailed:(OAServiceTicket_LinkedIn *)ticket withError:(NSError *)error;
...
- (void)callFailed:(OAServiceTicket_LinkedIn *)aTicket withError:(NSError *)error {
...
- (void)callFinished:(OAServiceTicket_LinkedIn *)aTicket withData:(NSData *)data {
	self.ticket = aTicket;
	[aTicket release];
...

{
	...
	request = [[OAMutableURLRequest_LinkedIn alloc] initWithURL:url
											  consumer:consumer
												token:token
                                              callback:nil
...
*/
	...
	fetcher = [[OADataFetcher_LinkedIn alloc] init];
