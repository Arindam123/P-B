...
//--------------------------------//
//@synthesize _venu_btn;
//@synthesize _pub_list;
int noofPubs;
int p;
...
//        obj_nearbymap = [[NearByMap alloc] initWithFrame:CGRectMake(0, 65, 320, 280) withArray:_pub_list];
//        
...
-(void)CreateView{
    ...
    //_venu_btn=[[UIButton alloc] init];//WithFrame:CGRectMake(120, 360, 80, 20)];
    //_venu_btn.titleLabel.font= [UIFont systemFontOfSize:12.0];
    //_venu_btn.layer.borderColor=[UIColor whiteColor].CGColor;
    //_venu_btn.layer.borderWidth=1.0;
    //_venu_btn.layer.cornerRadius=10.0;
    //_venu_btn.titleLabel.textColor=[UIColor whiteColor];
    //[_venu_btn setTitle:@"More" forState:UIControlStateNormal];
    //[_venu_btn addTarget:self action:@selector(MorebtnClick:) forControlEvents:UIControlEventTouchUpInside];
    //_venu_btn.backgroundColor=[UIColor colorWithRed:98.0/255.0 green:111.0/255.0 blue:127.0/255.0 alpha:1];
    //[self.view addSubview:_venu_btn];
    //[_venu_btn release];
