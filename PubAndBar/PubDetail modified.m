...
- (void)viewDidLoad
{
    ...
    [[DBFunctionality sharedInstance] InsertPubId_IntoPreference_RecentSearch:[Pub_ID intValue]];
    ...
    if ([categoryStr isEqualToString:@"Sports on TV"])
    {
        ...
        NSMutableArray *array4Keys = [NSMutableArray new];
        NSMutableArray *tempArray = [NSMutableArray new];
        
        
        for (int i =0; i<[[[arr objectAtIndex:0] allKeys] count]; i++) {
            
            [array4Keys addObject: [[[arr objectAtIndex:0] allKeys] objectAtIndex:i]];
            
        }
        NSLog(@"KEYS   %@  ",array4Keys);
        for (int i = 0; i<[array4Keys count]; i++) {
            
            if (![[[arr objectAtIndex:0]valueForKey:[array4Keys objectAtIndex:i]] isEqual:@"Not Available"] && ![[[arr objectAtIndex:0]valueForKey:[array4Keys objectAtIndex:i]] isEqual:@"No Info"]) {
                
                
                
                NSMutableDictionary *tempDic = [NSMutableDictionary new];
                [tempDic setObject:[[arr objectAtIndex:0]valueForKey:[array4Keys objectAtIndex:i]] forKey:[array4Keys objectAtIndex:i]];
        ...
        NSLog(@"VALKUEFORKWY   %@",[[tempArray objectAtIndex:0] valueForKey:@"Mobile"]);
        generalSectionArray = [[NSMutableArray alloc] init];
        for (int i =0; i<[tempArray count]; i++) {
            
            if ([[tempArray objectAtIndex:i] valueForKey:@"Mobile"] || 
                [[tempArray objectAtIndex:i] valueForKey:@"PubAddress"] || 
                [[tempArray objectAtIndex:i] valueForKey:@"PubCity"] ||
                [[tempArray objectAtIndex:i] valueForKey:@"PubCompany"] ||
                [[tempArray objectAtIndex:i] valueForKey:@"PubDistrict"] ||
                [[tempArray objectAtIndex:i] valueForKey:@"PubName"] ||
                [[tempArray objectAtIndex:i] valueForKey:@"PubPostCode"] ||
                [[tempArray objectAtIndex:i] valueForKey:@"PubWebsite"] ||
                [[tempArray objectAtIndex:i] valueForKey:@"PhoneNumber"]) 
            {
                [generalSectionArray addObject:[tempArray objectAtIndex:i]];
                
            }
        }
        [tempArray release];
        
        NSLog(@"ARRAMAIN   %@",generalSectionArray);
        ...
        str_mail=str_mobile=[[[arr objectAtIndex:0]valueForKey:@"PubEmail"]retain];
    ...
    else if ([categoryStr isEqualToString:@"What's On Tonight..."])
    {
        ...
        if ([arr count]!=0) {
            ...
            [arr removeAllObjects];
            if ((isregularEvent!=YES)&& (isoneoffEvent!=YES)&&(isthemenightEvent!=YES)) {
                issportsEvent=YES;
            }
        }
        ...
        if ([arr count]!=0) {
            ...
            if ((isregularEvent!=YES)&& (isoneoffEvent!=YES)) {
...
-(IBAction)CallDistributor:(id)sender
{
    if ([str_mobile length]>0)
    {
        if ([str_mobile isEqualToString:@"No Info"]) {
            UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Pub & Bar Network" message:@"No mobile no. exist.." delegate:nil cancelButtonTitle:nil otherButtonTitles:@"OK", nil];
            [alert show];
            [alert release];
        }else
        {
...
-(IBAction)ClickOnMap:(id)sender{
    ...
    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:[NSString stringWithFormat:@"http://maps.google.com/maps?daddr=%f,%f&saddr=%f,%f&dirflg=d",latitude,longitude,app.currentPoint.coordinate.latitude,app.currentPoint.coordinate.longitude]]];
...
-(IBAction)AddToFavourite:(id)sender
{
    ...
    UIAlertView *alert_insert=[[UIAlertView alloc]initWithTitle:nil message:[NSString stringWithFormat:@"%@ successfully added to your favourites.",[headerDictionaryData objectForKey:@"PubName"]] delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
    [alert_insert show];
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    ...
    if((section==0)&&([[Array_section objectAtIndex:0]isEqualToString:@"Regular Event"])){
        ...
        if(isGeneralExpanded ==YES)
            return [generalSectionArray count]+1;
    ...
    else if(((section==2)&&([[Array_section objectAtIndex:2]isEqualToString:@"Opening Hours"]))||((section==1)&&([[Array_section objectAtIndex:1]isEqualToString:@"Opening Hours"]))){
    ...
    else if(((section==3)&&([[Array_section objectAtIndex:3]isEqualToString:@"Other Details"]))||((section==2)&&([[Array_section objectAtIndex:2]isEqualToString:@"Other Details"]))){
    ...
    else if(((section==4)&&([[Array_section objectAtIndex:4]isEqualToString:@"Bullet Points"]))||((section==3)&&([[Array_section objectAtIndex:3]isEqualToString:@"Bullet Points"]))){
    ...
    else if(((section==5)&&([[Array_section objectAtIndex:5]isEqualToString:@"Description"]))||((section==4)&&([[Array_section objectAtIndex:4]isEqualToString:@"Description"]))){
    ...
    else if(((section==5)&&([[Array_section objectAtIndex:5]isEqualToString:@"One off Event"]))||((section==6)&&([[Array_section objectAtIndex:6]isEqualToString:@"One off Event"]))){
    ...
    else if(((section==5)&&([[Array_section objectAtIndex:5]isEqualToString:@"Theme Night"]))||((section==7)&&([[Array_section objectAtIndex:7]isEqualToString:@"Theme Night"]))||((section==6)&&([[Array_section objectAtIndex:6]isEqualToString:@"Theme Night"]))){
    ...
    else if(((section==5)&&([[Array_section objectAtIndex:5]isEqualToString:@"Sports Description"]))||((section==8)&&([[Array_section objectAtIndex:8]isEqualToString:@"Sports Description"]))||((section==6)&&([[Array_section objectAtIndex:6]isEqualToString:@"Sports Description"]))||((section==7)&&([[Array_section objectAtIndex:7]isEqualToString:@"Sports Description"]))){
    ...
    else if(((section==6)&&([[Array_section objectAtIndex:6]isEqualToString:@"Sports Event"]))||((section==9)&&([[Array_section objectAtIndex:9]isEqualToString:@"Sports Event"]))||((section==7)&&([[Array_section objectAtIndex:7]isEqualToString:@"Sports Event"]))||((section==8)&&([[Array_section objectAtIndex:8]isEqualToString:@"Sports Event"]))){
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
 	...
 	if(((indexPath.section==1)&&([[Array_section objectAtIndex:1]isEqualToString:@"General"]))||((indexPath.section==0)&&([[Array_section objectAtIndex:0]isEqualToString:@"General"])))
    {
        ...
        if (indexPath.row==0){
            ...
            if (indexPath.row==1){
                ...
                UILabel  *lblPubGeneralDisp1 = [Design LabelFormation:105 :0 :210 :65 :0];
            ...
            for (int i = 0; i<[generalSectionArray count]; i++) {
                
                NSArray *tempArray = [NSArray new];
                tempArray = [[[generalSectionArray objectAtIndex:i] allKeys] retain];
                [keysArray addObject:[tempArray objectAtIndex:0]];
                NSLog(@"keys  >>>>>>>>>> %@",[[generalSectionArray objectAtIndex:i] allKeys]);
            }
            if (![[keysArray objectAtIndex:indexPath.row-1] isEqual:@"PubAddress"]) {
                
                lblPubGeneral.text = [keysArray objectAtIndex:indexPath.row-1];
                lblPubGeneralDisp.text = [[generalSectionArray objectAtIndex:indexPath.row-1] valueForKey:[keysArray objectAtIndex:indexPath.row-1]];
            }
            ...
            /*if (indexPath.row==1){
                ...
                NSLog(@"ARRAy   %@   %@",generalSectionArray,keysArray);
                lblPubGeneral.text = [keysArray objectAtIndex:indexPath.row];
                lblPubGeneralDisp.text = [[generalSectionArray objectAtIndex:indexPath.row] valueForKey:[keysArray objectAtIndex:indexPath.row]];
            }
            else if (indexPath.row==3){
                lblPubGeneral.text = [keysArray objectAtIndex:indexPath.row];
                lblPubGeneralDisp.text = [[generalSectionArray objectAtIndex:indexPath.row] valueForKey:[keysArray objectAtIndex:indexPath.row]];
             ...
             if([[keysArray objectAtIndex:indexPath.row-1] isEqual:@"PubAddress"])
             {
                ...
                lblPubGeneral1.text =[keysArray objectAtIndex:indexPath.row-1];
                
                UILabel  *lblPubGeneralDisp1 = [Design LabelFormation:115 :0 :202 :65 :0];
                lblPubGeneralDisp1.autoresizingMask = UIViewAutoresizingFlexibleRightMargin | UIViewAutoresizingFlexibleLeftMargin |UIViewAutoresizingFlexibleWidth;    
                lblPubGeneralDisp1.numberOfLines=4;
                //lblPubGeneralDisp1.backgroundColor=[UIColor yellowColor];
                lblPubGeneralDisp1.text = [[generalSectionArray objectAtIndex:indexPath.row-1] valueForKey:[keysArray objectAtIndex:indexPath.row-1]];
                [cell.contentView addSubview:lblPubGeneralDisp1];
                [lblPubGeneralDisp1 release];
                [cell.contentView addSubview:lblPubGeneral1];
                [lblPubGeneral1 release];
    ...
    if(((indexPath.section==2)&&([[Array_section objectAtIndex:2]isEqualToString:@"Opening Hours"]))||((indexPath.section==1)&&([[Array_section objectAtIndex:1]isEqualToString:@"Opening Hours"]))){
    ...
    if(((indexPath.section==3)&&([[Array_section objectAtIndex:3]isEqualToString:@"Other Details"]))||((indexPath.section==2)&&([[Array_section objectAtIndex:2]isEqualToString:@"Other Details"]))){
    ...
    if(((indexPath.section==4)&&([[Array_section objectAtIndex:4]isEqualToString:@"Bullet Points"]))||((indexPath.section==3)&&([[Array_section objectAtIndex:3]isEqualToString:@"Bullet Points"]))){
        ...
        if (indexPath.row==0){
            ...
            if ([[[bulletPointArray objectAtIndex:indexPath.row-1] valueForKey:@"bullet"] length] == 0) {
                lblPubBulletsDesc.text =@"No Info"; //valueForKey:@"pubBullet"] retain];
            }
            else{
    ...
    if(((indexPath.section==5)&&([[Array_section objectAtIndex:5]isEqualToString:@"Description"]))||((indexPath.section==4)&&([[Array_section objectAtIndex:4]isEqualToString:@"Description"]))){
	...
	if(((indexPath.section==5)&&([[Array_section objectAtIndex:5]isEqualToString:@"One off Event"]))||((indexPath.section==6)&&([[Array_section objectAtIndex:6]isEqualToString:@"One off Event"]))){
    ...
    if(((indexPath.section==5)&&([[Array_section objectAtIndex:5]isEqualToString:@"Theme Night"]))||((indexPath.section==7)&&([[Array_section objectAtIndex:7]isEqualToString:@"Theme Night"]))||((indexPath.section==6)&&([[Array_section objectAtIndex:6]isEqualToString:@"Theme Night"]))){
	...
	if(((indexPath.section==5)&&([[Array_section objectAtIndex:5]isEqualToString:@"Sports Description"]))||((indexPath.section==8)&&([[Array_section objectAtIndex:8]isEqualToString:@"Sports Description"]))||((indexPath.section==6)&&([[Array_section objectAtIndex:6]isEqualToString:@"Sports Description"]))||((indexPath.section==7)&&([[Array_section objectAtIndex:7]isEqualToString:@"Sports Description"]))){
	...
	if(((indexPath.section==6)&&([[Array_section objectAtIndex:6]isEqualToString:@"Sports Event"]))||((indexPath.section==9)&&([[Array_section objectAtIndex:9]isEqualToString:@"Sports Event"]))||((indexPath.section==7)&&([[Array_section objectAtIndex:7]isEqualToString:@"Sports Event"]))||((indexPath.section==8)&&([[Array_section objectAtIndex:8]isEqualToString:@"Sports Event"]))){
    ...
    if(((indexPath.section==7)&&([[Array_section objectAtIndex:7]isEqualToString:@"Food Details"]))||((indexPath.section==6)&&([[Array_section objectAtIndex:6]isEqualToString:@"Food Details"]))||((indexPath.section==5)&&([[Array_section objectAtIndex:5]isEqualToString:@"Food Details"]))||((indexPath.section==10)&&([[Array_section objectAtIndex:10]isEqualToString:@"Food Details"]))||((indexPath.section==8)&&([[Array_section objectAtIndex:8]isEqualToString:@"Food Details"]))){
	...
	if(((indexPath.section==8)&&([[Array_section objectAtIndex:8]isEqualToString:@"Photos"]))||((indexPath.section==7)&&([[Array_section objectAtIndex:7]isEqualToString:@"Photos"]))||((indexPath.section==6)&&([[Array_section objectAtIndex:6]isEqualToString:@"Photos"]))||((indexPath.section==11)&&([[Array_section objectAtIndex:11]isEqualToString:@"Photos"]))||((indexPath.section==9)&&([[Array_section objectAtIndex:9]isEqualToString:@"Photos"]))){ 
		...
		if (indexPath.row==0){
			...
			[vw addSubview:imgMain];
			[imgMain release];
			UILabel *lblImage1 = [Design LabelFormation:43 :5 :100 :20 :0];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if(indexPath.row==0 ){
        ...
        else if(((indexPath.section==2)&&([[Array_section objectAtIndex:2]isEqualToString:@"Opening Hours"]))||((indexPath.section==1)&&([[Array_section objectAtIndex:1]isEqualToString:@"Opening Hours"]))){
            
            if(indexPath.row==0)
                NSLog(@"%d",indexPath.row);
            [self PrepareArrayList:2];
        }
        else if(((indexPath.section==3)&&([[Array_section objectAtIndex:3]isEqualToString:@"Other Details"]))||((indexPath.section==2)&&([[Array_section objectAtIndex:2]isEqualToString:@"Other Details"]))){
            
            if(indexPath.row==0)
                NSLog(@"%d",indexPath.row);
            [self PrepareArrayList:3];
        }
        else   if(((indexPath.section==4)&&([[Array_section objectAtIndex:4]isEqualToString:@"Bullet Points"]))||((indexPath.section==3)&&([[Array_section objectAtIndex:3]isEqualToString:@"Bullet Points"]))){
        ...
        else if(((indexPath.section==5)&&([[Array_section objectAtIndex:5]isEqualToString:@"Description"]))||((indexPath.section==4)&&([[Array_section objectAtIndex:4]isEqualToString:@"Description"]))){
        ...
        else if(((indexPath.section==5)&&([[Array_section objectAtIndex:5]isEqualToString:@"One off Event"]))||((indexPath.section==6)&&([[Array_section objectAtIndex:6]isEqualToString:@"One off Event"]))){
        ...
        else if(((indexPath.section==5)&&([[Array_section objectAtIndex:5]isEqualToString:@"Theme Night"]))||((indexPath.section==7)&&([[Array_section objectAtIndex:7]isEqualToString:@"Theme Night"]))||((indexPath.section==6)&&([[Array_section objectAtIndex:6]isEqualToString:@"Theme Night"]))){
        ...
        else if(((indexPath.section==6)&&([[Array_section objectAtIndex:6]isEqualToString:@"Sports Event"]))||((indexPath.section==9)&&([[Array_section objectAtIndex:9]isEqualToString:@"Sports Event"]))||((indexPath.section==7)&&([[Array_section objectAtIndex:7]isEqualToString:@"Sports Event"]))||((indexPath.section==8)&&([[Array_section objectAtIndex:8]isEqualToString:@"Sports Event"]))){
	...
	else
    {
        ...
        else if(((indexPath.section==8)&&([[Array_section objectAtIndex:8]isEqualToString:@"Photos"]))||((indexPath.section==7)&&([[Array_section objectAtIndex:7]isEqualToString:@"Photos"]))||((indexPath.section==6)&&([[Array_section objectAtIndex:6]isEqualToString:@"Photos"]))){ 
