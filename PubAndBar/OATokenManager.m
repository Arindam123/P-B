...
- (void)setAccessToken:(OAToken_LinkedIn *)token;
...
- (id)initWithConsumer:(OAConsumer_LinkedIn *)aConsumer token:(OAToken_LinkedIn *)aToken oauthBase:(const NSString *)base
...
- (void)requestToken
{
	...
	OAToken_LinkedIn *atoken = [[[OAToken_LinkedIn alloc] initWithUserDefaultsUsingServiceProviderName:oauthBase prefix:[@"access:" stringByAppendingString:realm]] autorelease];
	...
	OAToken_LinkedIn *token = [[[OAToken_LinkedIn alloc] initWithUserDefaultsUsingServiceProviderName:oauthBase prefix:[@"request:" stringByAppendingString:realm]] autorelease];
...
- (void)requestTokenReceived:(OACall *)call body:(NSString *)body
{
	...
	OAToken_LinkedIn *token = [[[OAToken_LinkedIn alloc] initWithHTTPResponseBody:body] autorelease];
	if (token) {
		[reqToken release];
		reqToken = [token retain];
...
{
	OAToken_LinkedIn *token = [[OAToken_LinkedIn alloc] initWithHTTPResponseBody:body];
...
- (void)setAccessToken:(OAToken_LinkedIn *)token {
	...
	if (token) {
		...
		[acToken release];
		acToken = nil;
		[OAToken_LinkedIn removeFromUserDefaultsWithServiceProviderName:oauthBase prefix:[@"access:" stringByAppendingString:realm]];
	}
}

- (void)deleteSavedRequestToken {
	[OAToken_LinkedIn removeFromUserDefaultsWithServiceProviderName:oauthBase prefix:[@"request:" stringByAppendingString:realm]];
	[reqToken release];
	reqToken = nil;
}
